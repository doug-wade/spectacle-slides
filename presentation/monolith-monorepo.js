...
const workspacesPackageJson =
  require("raw-loader!../code-examples/workspaces-package-json.example").default;
const turboJson =
  require("raw-loader!../code-examples/turbo-json.example").default;
